...
<div
    ...
    <div
        ...
        <div
            ...
            <div
                class="flex flex-shrink-0 items-center justify-between rounded-t-md bg-pink-300 border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                <!--Modal title-->
                <h5
                    class="text-xl font-medium leading-normal text-black dark:text-neutral-200"
